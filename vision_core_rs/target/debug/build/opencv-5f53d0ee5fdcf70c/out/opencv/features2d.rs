pub mod features2d {
	...
	impl BRISK {
		...
		#[inline]
		fn default() -> Self {
			unsafe { Self::from_raw(sys::cv_BRISK_defaultNew_const()) }
		}
	...
	impl SIFT {
		...
		#[inline]
		fn default() -> Self {
			unsafe { Self::from_raw(sys::cv_SIFT_defaultNew_const()) }
		}
	...
	impl SimpleBlobDetector {
		...
		#[inline]
		fn default() -> Self {
			unsafe { Self::from_raw(sys::cv_SimpleBlobDetector_defaultNew_const()) }
		}
